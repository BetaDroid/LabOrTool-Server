...
module.exports = function(router) {
    ...
    router.post(Api.version+'/user/employees/', function (req, res) {
        Employee.insert(req.body);
        res.json({});
    });

    router.get(Api.version+'/user/employees/:id', function (req, res) {
        Employee.getById(req.params.id, function(data) {
            res.json(data);
        });
    });

    router.put(Api.version+'/user/employees/:id', function (req, res) {
        Employee.update(req.params.id, req.body);
        res.json({});
    });

    router.delete(Api.version+'/user/employees/:id', function (req, res) {
        Employee.delete(req.params.id);
        res.json({});
    });

    router.get(Api.version+'/user/employees/search/:text', function (req, res) {
